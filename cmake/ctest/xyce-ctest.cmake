...
function(CONVERTTESTXML inputfn subdirname track outfname)
  ...
  foreach(fline ${lines_list})
    if("${fline}" MATCHES "BuildStamp=\"(.*)\"")
      ...
      if(VERBOSITY GREATER 1)
       message(STATUS "[VERB1]: outfline: ${outfline}")
      endif() 
    else()
...
if (NOT USE_CTEST_TESTING)
  ...
  if(${CDASHVER} EQUAL 3.1)
    find_program(XYCE_CDASH_GEN summary-dart-nosubmit.cdash-v3p1.pl
      ...
      REQUIRED)
  elseif(${CDASHVER} EQUAL 4)
    find_program(XYCE_CDASH_GEN summary-cdash-v4.py
      HINTS $ENV{WORKSPACE}/Scripts/reporting
      REQUIRED)
  else()
...
foreach(cmakeopt IN LISTS CMAKE_ARGS_LIST)
  ...
  if(_pos GREATER -1)
    ...
    message(STATUS "WARNING: No -DCMAKE_BUILD_TYPE= flag found. Setting to \"Debug\".")
...
if(buildReturnVal EQUAL 0)
  if(USE_CTEST_TESTING)
    ...
    if(MPI_TESTING)
      ...
      set(MPICMD "mpirun -np 2 --bind-to none ${XYCE_EXE}")
    ...
    foreach(fname IN LISTS regFileNames)
      ...
      if(VERBOSITY GREATER 3)
        message("[VERB4]: Command was:")
        message("[VERB4]: ${XYCE_CDASH_GEN} ${CTEST_SITE} $ENV{MYBUILDNAME} $ENV{branch} ${fname} $ENV{TESTSET}")
      ...
      if(NOT xyce_cdash_gen_result EQUAL 0)
        message(FATAL_ERROR "ERROR: Conversion of results to XML failed.")
      endif()
      ...
      if(VERBOSITY GREATER_EQUAL 1) 
        message("[VERB1]: Converting Xyce test XML file '${fname}.xml' to ctest format in subdirectory '${testSubDirName}'")
      endif()
...
if(VERBOSITY GREATER_EQUAL 1)
  message("[VERB1]: DASHSUBMIT: ${DASHSUBMIT}")
endif()
