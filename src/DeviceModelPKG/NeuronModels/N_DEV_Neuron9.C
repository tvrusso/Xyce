...
{
  p.addPar ("CMEM",0.0,&Neuron9::Model::cMem)
   .setGivenMember(&Neuron9::Model::cMemGiven)
   .setUnit(U_FARAD)
   .setCategory(CAT_NONE)
   .setDescription("Membrane capacitance");

  p.addPar ("ELEAK",0.0,&Neuron9::Model::eLeak)
   .setGivenMember(&Neuron9::Model::eLeakGiven)
   .setUnit(U_VOLT)
   .setCategory(CAT_NONE)
   .setDescription("Leak current reversal potential");

  p.addPar ("GMEM",0.0,&Neuron9::Model::gMem)
   .setGivenMember(&Neuron9::Model::gMemGiven)
   .setUnit(U_OHMM1)
   .setCategory(CAT_NONE)
   .setDescription("Membrane conductance");

  p.addPar ("EK",0.0,&Neuron9::Model::eK)
   .setGivenMember(&Neuron9::Model::eKGiven)
   .setUnit(U_VOLT)
   .setCategory(CAT_NONE)
   .setDescription("Potassium reversal potential");

  p.addPar ("GK",0.0,&Neuron9::Model::gK)
   .setGivenMember(&Neuron9::Model::gKGiven)
   .setUnit(U_OHMM1)
   .setCategory(CAT_NONE)
   .setDescription("Potassium base conductance");

  p.addPar ("ENA",0.0,&Neuron9::Model::eNa)
   .setGivenMember(&Neuron9::Model::eNaGiven)
   .setUnit(U_VOLT)
   .setCategory(CAT_NONE)
   .setDescription("Sodium reversal potential");

  p.addPar ("GNA",0.0,&Neuron9::Model::gNa)
   .setGivenMember(&Neuron9::Model::gNaGiven)
   .setUnit(U_OHMM1)
   .setCategory(CAT_NONE)
   .setDescription("Sodium base conductance");

  p.addPar ("VREST",0.0,&Neuron9::Model::vRest)
   .setGivenMember(&Neuron9::Model::vRestGiven)
   .setUnit(U_VOLT)
   .setCategory(CAT_NONE)
...
{
  if (deviceMap.empty() ||
      ((deviceMap.find("NEURON")!=deviceMap.end()) && (levelSet.find(9)!=levelSet.end())))
  {
