...
{
  p.addPar ("MEMC",0.0,&Neuron7::Instance::memCap)
   .setGivenMember(&Neuron7::Instance::memCapGiven)
   .setUnit(U_FARAD)
   .setCategory(CAT_NONE)
   .setDescription("Membrane capacitance");

  p.addPar ("VT",0.0,&Neuron7::Instance::Vt)
   .setGivenMember(&Neuron7::Instance::VtGiven)
   .setUnit(U_VOLT)
   .setCategory(CAT_NONE)
   .setDescription("Instantaneous threshold voltage");

  p.addPar ("VR",0.0,&Neuron7::Instance::Vr)
   .setGivenMember(&Neuron7::Instance::VrGiven)
   .setUnit(U_VOLT)
   .setCategory(CAT_NONE)
   .setDescription("Resting membrane potential");

  p.addPar ("VP",0.0,&Neuron7::Instance::Vpeak)
   .setGivenMember(&Neuron7::Instance::VpeakGiven)
   .setUnit(U_VOLT)
   .setCategory(CAT_NONE)
   .setDescription("Peak voltage");

  p.addPar ("K",0.0,&Neuron7::Instance::k)
   .setGivenMember(&Neuron7::Instance::kGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("instanceing parameter");

  p.addPar ("A",0.0,&Neuron7::Instance::a)
   .setGivenMember(&Neuron7::Instance::aGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("instanceing parameter");

  p.addPar ("B",0.0,&Neuron7::Instance::b)
   .setGivenMember(&Neuron7::Instance::bGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("instanceing parameter");

  p.addPar ("C",0.0,&Neuron7::Instance::c)
   .setGivenMember(&Neuron7::Instance::cGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("instanceing parameter");

  p.addPar ("D",0.0,&Neuron7::Instance::d)
   .setGivenMember(&Neuron7::Instance::dGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("instanceing parameter");

  p.addPar ("USCALE",1.0e-9,&Neuron7::Instance::uscale)
   .setGivenMember(&Neuron7::Instance::uscaleGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("scaling for u variable");

  p.addPar ("FALLRATE",1.0e3,&Neuron7::Instance::fallRate)
   .setGivenMember(&Neuron7::Instance::fallRateGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
...
{
  p.addPar ("MEMC",0.0,&Neuron7::Model::memCap)
   .setGivenMember(&Neuron7::Model::memCapGiven)
   .setUnit(U_FARAD)
   .setCategory(CAT_NONE)
   .setDescription("Membrane capacitance");

  p.addPar ("VT",0.0,&Neuron7::Model::Vt)
   .setGivenMember(&Neuron7::Model::VtGiven)
   .setUnit(U_VOLT)
   .setCategory(CAT_NONE)
   .setDescription("Instantaneous threshold voltage");

  p.addPar ("VR",0.0,&Neuron7::Model::Vr)
   .setGivenMember(&Neuron7::Model::VrGiven)
   .setUnit(U_VOLT)
   .setCategory(CAT_NONE)
   .setDescription("Resting membrane potential");

  p.addPar ("VP",0.0,&Neuron7::Model::Vpeak)
   .setGivenMember(&Neuron7::Model::VpeakGiven)
   .setUnit(U_VOLT)
   .setCategory(CAT_NONE)
   .setDescription("Peak voltage");

  p.addPar ("K",0.0,&Neuron7::Model::k)
   .setGivenMember(&Neuron7::Model::kGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Neuron7::Modeling parameter");

  p.addPar ("A",0.0,&Neuron7::Model::a)
   .setGivenMember(&Neuron7::Model::aGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Neuron7::Modeling parameter");

  p.addPar ("B",0.0,&Neuron7::Model::b)
   .setGivenMember(&Neuron7::Model::bGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Neuron7::Modeling parameter");

  p.addPar ("C",0.0,&Neuron7::Model::c)
   .setGivenMember(&Neuron7::Model::cGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Neuron7::Modeling parameter");

  p.addPar ("D",0.0,&Neuron7::Model::d)
   .setGivenMember(&Neuron7::Model::dGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Neuron7::Modeling parameter");

  p.addPar ("USCALE",1.0e-9,&Neuron7::Model::uscale)
   .setGivenMember(&Neuron7::Model::uscaleGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("scaling for u variable");

  p.addPar ("FALLRATE",1.0e3,&Neuron7::Model::fallRate)
   .setGivenMember(&Neuron7::Model::fallRateGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("recovery rate");
}
...
{
  if (deviceMap.empty() ||
      ((deviceMap.find("NEURON")!=deviceMap.end()) && (levelSet.find(7)!=levelSet.end())))
  {
