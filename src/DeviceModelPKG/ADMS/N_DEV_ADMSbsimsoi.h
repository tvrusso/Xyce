...
// Purpose        :
//
// Special Notes  : Generated from verilog file bsimsoi.va with ADMS
...
#define Xyce_N_DEV_ADMSbsimsoi_h
...
double instancePar_MULT_I;
double d_instancePar_MULT_I_dX;
bool instancePar_given_MULT_I;
double instancePar_MULT_Q;
double d_instancePar_MULT_Q_dX;
bool instancePar_given_MULT_Q;
double instancePar_MULT_FN;
double d_instancePar_MULT_FN_dX;
bool instancePar_given_MULT_FN;
...
double instanceVar_B4SOIsourceResistance;
double d_instanceVar_B4SOIsourceResistance_dX;
double instanceVar_B4SOIdrainResistance;
double d_instanceVar_B4SOIdrainResistance_dX;
...
double instanceVar_pParam_B4SOIprwe;
double d_instanceVar_pParam_B4SOIprwe_dX;
...
double instanceVar_pParam_B4SOIaigc1;
double d_instanceVar_pParam_B4SOIaigc1_dX;
...
double instanceVar_pParam_B4SOIaigsd1;
double d_instanceVar_pParam_B4SOIaigsd1_dX;
...
double instanceVar_pParam_B4SOIigt;
double d_instanceVar_pParam_B4SOIigt_dX;
double instanceVar_pParam_B4SOIvbsa;
double d_instanceVar_pParam_B4SOIvbsa_dX;
double instanceVar_pParam_B4SOIvsce;
double d_instanceVar_pParam_B4SOIvsce_dX;
double instanceVar_pParam_B4SOIcdsbs;
double d_instanceVar_pParam_B4SOIcdsbs_dX;
double instanceVar_pParam_B4SOInofffd;
double d_instanceVar_pParam_B4SOInofffd_dX;
double instanceVar_pParam_B4SOIvofffd;
double d_instanceVar_pParam_B4SOIvofffd_dX;
double instanceVar_pParam_B4SOIk1b;
double d_instanceVar_pParam_B4SOIk1b_dX;
double instanceVar_pParam_B4SOIk2b;
double d_instanceVar_pParam_B4SOIk2b_dX;
double instanceVar_pParam_B4SOIdk2b;
double d_instanceVar_pParam_B4SOIdk2b_dX;
double instanceVar_pParam_B4SOIdvbd0;
double d_instanceVar_pParam_B4SOIdvbd0_dX;
double instanceVar_pParam_B4SOIdvbd1;
double d_instanceVar_pParam_B4SOIdvbd1_dX;
double instanceVar_pParam_B4SOImoinfd;
double d_instanceVar_pParam_B4SOImoinfd_dX;
...
double instanceVar_pParam_B4SOIalphaGB1_T;
double d_instanceVar_pParam_B4SOIalphaGB1_T_dX;
...
double instanceVar_pParam_B4SOIalphaGB2_T;
double d_instanceVar_pParam_B4SOIalphaGB2_T_dX;
double instanceVar_pParam_B4SOIaigbcp2_T;
double d_instanceVar_pParam_B4SOIaigbcp2_T_dX;
...
double instanceVar_pParam_B4SOIbgidl1;
double d_instanceVar_pParam_B4SOIbgidl1_dX;
...
double instanceVar_pParam_B4SOIbgisl1;
double d_instanceVar_pParam_B4SOIbgisl1_dX;
...
double instanceVar_pParam_B4SOInoff2;
double d_instanceVar_pParam_B4SOInoff2_dX;
...
double instanceVar_here_B4SOIk1ox;
double d_instanceVar_here_B4SOIk1ox_dX;
...
double instanceVar_TRm1;
double d_instanceVar_TRm1_dX;
// non-reals
...
double modelPar_MULT_I;
double d_modelPar_MULT_I_dX;
bool modelPar_given_MULT_I;
double modelPar_MULT_Q;
double d_modelPar_MULT_Q_dX;
bool modelPar_given_MULT_Q;
double modelPar_MULT_FN;
double d_modelPar_MULT_FN_dX;
bool modelPar_given_MULT_FN;
...
double modelPar_UBG1;
double d_modelPar_UBG1_dX;
bool modelPar_given_UBG1;
double modelPar_UBG2;
double d_modelPar_UBG2_dX;
bool modelPar_given_UBG2;
...
double modelPar_RSC;
double d_modelPar_RSC_dX;
bool modelPar_given_RSC;
double modelPar_RDC;
double d_modelPar_RDC_dX;
bool modelPar_given_RDC;
double modelPar_TRS;
double d_modelPar_TRS_dX;
bool modelPar_given_TRS;
double modelPar_TRD;
double d_modelPar_TRD_dX;
bool modelPar_given_TRD;
...
double modelPar_PRWE;
double d_modelPar_PRWE_dX;
bool modelPar_given_PRWE;
double modelPar_PRT;
...
double modelPar_BGIDL1;
double d_modelPar_BGIDL1_dX;
bool modelPar_given_BGIDL1;
...
double modelPar_BGISL1;
double d_modelPar_BGISL1_dX;
bool modelPar_given_BGISL1;
...
double modelPar_NOFF2;
double d_modelPar_NOFF2_dX;
bool modelPar_given_NOFF2;
...
double modelPar_ALPHAGB1_T;
double d_modelPar_ALPHAGB1_T_dX;
bool modelPar_given_ALPHAGB1_T;
...
double modelPar_ALPHAGB2_T;
double d_modelPar_ALPHAGB2_T_dX;
bool modelPar_given_ALPHAGB2_T;
...
double modelPar_AIGBCP2_T;
double d_modelPar_AIGBCP2_T_dX;
bool modelPar_given_AIGBCP2_T;
...
double modelPar_AIGSD1;
double d_modelPar_AIGSD1_dX;
bool modelPar_given_AIGSD1;
...
double modelPar_RVER;
double d_modelPar_RVER_dX;
bool modelPar_given_RVER;
double modelPar_XGW;
...
double modelPar_LALPHAGB1_T;
double d_modelPar_LALPHAGB1_T_dX;
bool modelPar_given_LALPHAGB1_T;
...
double modelPar_LALPHAGB2_T;
double d_modelPar_LALPHAGB2_T_dX;
bool modelPar_given_LALPHAGB2_T;
...
double modelPar_LAIGBCP2_T;
double d_modelPar_LAIGBCP2_T_dX;
bool modelPar_given_LAIGBCP2_T;
...
double modelPar_LAIGSD1;
double d_modelPar_LAIGSD1_dX;
bool modelPar_given_LAIGSD1;
...
double modelPar_LPRWE;
double d_modelPar_LPRWE_dX;
bool modelPar_given_LPRWE;
...
double modelPar_LBGIDL1;
double d_modelPar_LBGIDL1_dX;
bool modelPar_given_LBGIDL1;
...
double modelPar_LBGISL1;
double d_modelPar_LBGISL1_dX;
bool modelPar_given_LBGISL1;
...
double modelPar_LNOFF2;
double d_modelPar_LNOFF2_dX;
bool modelPar_given_LNOFF2;
...
double modelPar_LVBSA;
double d_modelPar_LVBSA_dX;
bool modelPar_given_LVBSA;
double modelPar_LVSCE;
double d_modelPar_LVSCE_dX;
bool modelPar_given_LVSCE;
double modelPar_LCDSBS;
double d_modelPar_LCDSBS_dX;
bool modelPar_given_LCDSBS;
double modelPar_LNOFFFD;
double d_modelPar_LNOFFFD_dX;
bool modelPar_given_LNOFFFD;
double modelPar_LVOFFFD;
double d_modelPar_LVOFFFD_dX;
bool modelPar_given_LVOFFFD;
double modelPar_LK1B;
double d_modelPar_LK1B_dX;
bool modelPar_given_LK1B;
double modelPar_LK2B;
double d_modelPar_LK2B_dX;
bool modelPar_given_LK2B;
double modelPar_LDK2B;
double d_modelPar_LDK2B_dX;
bool modelPar_given_LDK2B;
double modelPar_LDVBD0;
double d_modelPar_LDVBD0_dX;
bool modelPar_given_LDVBD0;
double modelPar_LDVBD1;
double d_modelPar_LDVBD1_dX;
bool modelPar_given_LDVBD1;
double modelPar_LMOINFD;
double d_modelPar_LMOINFD_dX;
bool modelPar_given_LMOINFD;
double modelPar_LVBS0PD;
double d_modelPar_LVBS0PD_dX;
bool modelPar_given_LVBS0PD;
double modelPar_LVBS0FD;
double d_modelPar_LVBS0FD_dX;
bool modelPar_given_LVBS0FD;
double modelPar_WXJ;
...
double modelPar_WALPHAGB1_T;
double d_modelPar_WALPHAGB1_T_dX;
bool modelPar_given_WALPHAGB1_T;
...
double modelPar_WALPHAGB2_T;
double d_modelPar_WALPHAGB2_T_dX;
bool modelPar_given_WALPHAGB2_T;
...
double modelPar_WAIGBCP2_T;
double d_modelPar_WAIGBCP2_T_dX;
bool modelPar_given_WAIGBCP2_T;
...
double modelPar_WAIGSD1;
double d_modelPar_WAIGSD1_dX;
bool modelPar_given_WAIGSD1;
...
double modelPar_WPRWE;
double d_modelPar_WPRWE_dX;
bool modelPar_given_WPRWE;
...
double modelPar_WBGIDL1;
double d_modelPar_WBGIDL1_dX;
bool modelPar_given_WBGIDL1;
...
double modelPar_WBGISL1;
double d_modelPar_WBGISL1_dX;
bool modelPar_given_WBGISL1;
...
double modelPar_WNOFF2;
double d_modelPar_WNOFF2_dX;
bool modelPar_given_WNOFF2;
...
double modelPar_WVBSA;
double d_modelPar_WVBSA_dX;
bool modelPar_given_WVBSA;
double modelPar_WVSCE;
double d_modelPar_WVSCE_dX;
bool modelPar_given_WVSCE;
double modelPar_WCDSBS;
double d_modelPar_WCDSBS_dX;
bool modelPar_given_WCDSBS;
double modelPar_WNOFFFD;
double d_modelPar_WNOFFFD_dX;
bool modelPar_given_WNOFFFD;
double modelPar_WVOFFFD;
double d_modelPar_WVOFFFD_dX;
bool modelPar_given_WVOFFFD;
double modelPar_WK1B;
double d_modelPar_WK1B_dX;
bool modelPar_given_WK1B;
double modelPar_WK2B;
double d_modelPar_WK2B_dX;
bool modelPar_given_WK2B;
double modelPar_WDK2B;
double d_modelPar_WDK2B_dX;
bool modelPar_given_WDK2B;
double modelPar_WDVBD0;
double d_modelPar_WDVBD0_dX;
bool modelPar_given_WDVBD0;
double modelPar_WDVBD1;
double d_modelPar_WDVBD1_dX;
bool modelPar_given_WDVBD1;
double modelPar_WMOINFD;
double d_modelPar_WMOINFD_dX;
bool modelPar_given_WMOINFD;
double modelPar_WVBS0PD;
double d_modelPar_WVBS0PD_dX;
bool modelPar_given_WVBS0PD;
double modelPar_WVBS0FD;
double d_modelPar_WVBS0FD_dX;
bool modelPar_given_WVBS0FD;
double modelPar_PXJ;
...
double modelPar_PALPHAGB1_T;
double d_modelPar_PALPHAGB1_T_dX;
bool modelPar_given_PALPHAGB1_T;
...
double modelPar_PALPHAGB2_T;
double d_modelPar_PALPHAGB2_T_dX;
bool modelPar_given_PALPHAGB2_T;
...
double modelPar_PAIGBCP2_T;
double d_modelPar_PAIGBCP2_T_dX;
bool modelPar_given_PAIGBCP2_T;
...
double modelPar_PAIGSD1;
double d_modelPar_PAIGSD1_dX;
bool modelPar_given_PAIGSD1;
...
double modelPar_PPRWE;
double d_modelPar_PPRWE_dX;
bool modelPar_given_PPRWE;
...
double modelPar_PBGIDL1;
double d_modelPar_PBGIDL1_dX;
bool modelPar_given_PBGIDL1;
...
double modelPar_PBGISL1;
double d_modelPar_PBGISL1_dX;
bool modelPar_given_PBGISL1;
...
double modelPar_PNOFF2;
double d_modelPar_PNOFF2_dX;
bool modelPar_given_PNOFF2;
...
double modelPar_PVBSA;
double d_modelPar_PVBSA_dX;
bool modelPar_given_PVBSA;
double modelPar_PVSCE;
double d_modelPar_PVSCE_dX;
bool modelPar_given_PVSCE;
double modelPar_PCDSBS;
double d_modelPar_PCDSBS_dX;
bool modelPar_given_PCDSBS;
double modelPar_PNOFFFD;
double d_modelPar_PNOFFFD_dX;
bool modelPar_given_PNOFFFD;
double modelPar_PVOFFFD;
double d_modelPar_PVOFFFD_dX;
bool modelPar_given_PVOFFFD;
double modelPar_PK1B;
double d_modelPar_PK1B_dX;
bool modelPar_given_PK1B;
double modelPar_PK2B;
double d_modelPar_PK2B_dX;
bool modelPar_given_PK2B;
double modelPar_PDK2B;
double d_modelPar_PDK2B_dX;
bool modelPar_given_PDK2B;
double modelPar_PDVBD0;
double d_modelPar_PDVBD0_dX;
bool modelPar_given_PDVBD0;
double modelPar_PDVBD1;
double d_modelPar_PDVBD1_dX;
bool modelPar_given_PDVBD1;
double modelPar_PMOINFD;
double d_modelPar_PMOINFD_dX;
bool modelPar_given_PMOINFD;
double modelPar_PVBS0PD;
double d_modelPar_PVBS0PD_dX;
bool modelPar_given_PVBS0PD;
double modelPar_PVBS0FD;
double d_modelPar_PVBS0FD_dX;
bool modelPar_given_PVBS0FD;
double modelPar_NLX;
...
int modelPar_NODECHK;
bool modelPar_given_NODECHK;
...
int modelPar_IDS0MULTMOD;
bool modelPar_given_IDS0MULTMOD;
int modelPar_FDMOD;
...
public:
    ...
    bool loadDAEdFdx ();
      ...
      void collapseNodes();
      int getNumNoiseSources () const;  // 18
  ...
  public:
    // iterator reference to the bsimsoi model which owns this instance.
    // Getters and setters
    Model &getModel()
    {
      return model_;
  ...
  private:
    ...
    double B4SOIrds;
    double B4SOIAbulk;
     double d_B4SOIAbulk_dV_b_si;
     double d_B4SOIAbulk_dV_e_si;
    ...
    double B4SOIVdseff;
     double d_B4SOIVdseff_dV_b_si;
     double d_B4SOIVdseff_dV_e_si;
    ...
    double pParam_B4SOIaigc;
     double d_pParam_B4SOIaigc_dTemp_t_GND;
     double d_pParam_B4SOIaigc_dV_p_GND;
     double d_pParam_B4SOIaigc_dV_b_GND;
    double pParam_B4SOIaigc1;
    double pParam_B4SOIbigc;
    double pParam_B4SOIcigc;
    double pParam_B4SOIaigsd;
     double d_pParam_B4SOIaigsd_dTemp_t_GND;
     double d_pParam_B4SOIaigsd_dV_p_GND;
     double d_pParam_B4SOIaigsd_dV_b_GND;
    double pParam_B4SOIaigsd1;
    ...
    double pParam_B4SOIigt;
    double pParam_B4SOIvbsa;
    double pParam_B4SOIvsce;
    double pParam_B4SOIcdsbs;
    double pParam_B4SOInofffd;
    double pParam_B4SOIvofffd;
    double pParam_B4SOIk1b;
    double pParam_B4SOIk2b;
    double pParam_B4SOIdk2b;
    double pParam_B4SOIdvbd0;
    double pParam_B4SOIdvbd1;
    double pParam_B4SOImoinfd;
    ...
    double pParam_B4SOIalphaGB1;
     double d_pParam_B4SOIalphaGB1_dTemp_t_GND;
     double d_pParam_B4SOIalphaGB1_dV_p_GND;
     double d_pParam_B4SOIalphaGB1_dV_b_GND;
    double pParam_B4SOIalphaGB1_T;
    double pParam_B4SOIbetaGB1;
    double pParam_B4SOIalphaGB2;
     double d_pParam_B4SOIalphaGB2_dTemp_t_GND;
     double d_pParam_B4SOIalphaGB2_dV_p_GND;
     double d_pParam_B4SOIalphaGB2_dV_b_GND;
    double pParam_B4SOIalphaGB2_T;
    double pParam_B4SOIaigbcp2_T;
    double pParam_B4SOIbetaGB2;
    double pParam_B4SOIaigbcp2;
     double d_pParam_B4SOIaigbcp2_dTemp_t_GND;
     double d_pParam_B4SOIaigbcp2_dV_p_GND;
     double d_pParam_B4SOIaigbcp2_dV_b_GND;
    ...
    double here_B4SOIk1ox;
     double d_here_B4SOIk1ox_dTemp_t_GND;
     double d_here_B4SOIk1ox_dV_p_GND;
     double d_here_B4SOIk1ox_dV_b_GND;
    ...
    double here_B4SOIk2ox;
     double d_here_B4SOIk2ox_dTemp_t_GND;
     double d_here_B4SOIk2ox_dV_p_GND;
     double d_here_B4SOIk2ox_dV_b_GND;
    ...
    double Tnom;
    double TRm1;
     double d_TRm1_dTemp_t_GND;
     double d_TRm1_dV_p_GND;
     double d_TRm1_dV_b_GND;
    ...
    double * f_N_Equ_sb_Node_Ptr;
    double * f_N_Equ_si_Node_Ptr;
    double * f_N_Equ_db_Node_Ptr;
    double * f_N_Equ_di_Node_Ptr;
    double * f_N_Equ_gi_Node_Ptr;
    double * f_N_Equ_p_Node_Ptr;
    double * f_N_Equ_gm_Node_Ptr;
    double * f_N_Equ_b_Node_Ptr;
    ...
    double * q_N_Equ_sb_Node_Ptr;
    double * q_N_Equ_si_Node_Ptr;
    double * q_N_Equ_db_Node_Ptr;
    double * q_N_Equ_di_Node_Ptr;
    double * q_N_Equ_gi_Node_Ptr;
    double * q_N_Equ_p_Node_Ptr;
    double * q_N_Equ_gm_Node_Ptr;
    double * q_N_Equ_b_Node_Ptr;
    ...
    int A_N_Equ_sb_NodeOffset;
    int A_N_Equ_si_NodeOffset;
    int A_N_Equ_db_NodeOffset;
    int A_N_Equ_di_NodeOffset;
    int A_N_Equ_gi_NodeOffset;
    int A_N_Equ_p_NodeOffset;
    int A_N_Equ_gm_NodeOffset;
    int A_N_Equ_b_NodeOffset;
...
// optional node t:
    ...
    static const int admsNodeID_N = 6+7;
   ...
   // Probe numbers
    ...
    static const int admsProbeID_V_gm_GND = 2;
    static const int admsProbeID_V_b_sb = 3;
    static const int admsProbeID_V_b_db = 4;
    static const int admsProbeID_V_gm_gi = 5;
    static const int admsProbeID_V_g_gm = 6;
    static const int admsProbeID_V_gi_e = 7;
    static const int admsProbeID_V_gm_e = 8;
    static const int admsProbeID_V_gi_di = 9;
    static const int admsProbeID_V_si_di = 10;
    static const int admsProbeID_V_s_si = 11;
    static const int admsProbeID_V_d_di = 12;
    static const int admsProbeID_V_N_GND = 13;
    static const int admsProbeID_V_si_GND = 14;
    static const int admsProbeID_V_di_GND = 15;
    static const int admsProbeID_V_gi_GND = 16;
    static const int admsProbeID_V_gm_si = 17;
    static const int admsProbeID_V_db_di = 18;
    static const int admsProbeID_V_sb_si = 19;
    static const int admsProbeID_V_gi_p = 20;
    static const int admsProbeID_V_b_p = 21;
    static const int admsProbeID_V_e_si = 22;
    static const int admsProbeID_V_gi_si = 23;
    static const int admsProbeID_V_b_si = 24;
    static const int admsProbeID_V_di_si = 25;
    static const int admsProbeID_Temp_t_GND = 26;
    static const int admsProbeID_V_p_GND = 27;
    static const int admsProbeID_V_b_GND = 28;
   // end probe numbers
   // Store LIDs
   // end store LIDs
...
#endif //Xyce_N_DEV_ADMSbsimsoi_h
