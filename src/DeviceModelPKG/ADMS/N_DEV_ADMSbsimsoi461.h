...
// Purpose        :
//
// Special Notes  : Generated from verilog file bsimsoi461.va with ADMS
...
#define Xyce_N_DEV_ADMSbsimsoi461_h
...
int instancePar_DEBUG;
bool instancePar_given_DEBUG;
...
{
  static const char *name() {return "BSIM-SOI 4.6.1";}
...
public:
  ...
  public:
    // iterator reference to the bsimsoi461 model which owns this instance.
    // Getters and setters
    Model &getModel()
    {
      return model_;
...
#endif //Xyce_N_DEV_ADMSbsimsoi461_h
