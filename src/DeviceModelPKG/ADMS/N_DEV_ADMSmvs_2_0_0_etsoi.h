...
//
// Creation Date  : Thu, 23 May 2024 20:30:08
//
//-----------------------------------------------------------------------------
#ifndef Xyce_N_DEV_ADMSmvs_2_0_0_etsoi_h
#define Xyce_N_DEV_ADMSmvs_2_0_0_etsoi_h
...
double modelPar_Rs0;
double d_modelPar_Rs0_dX;
bool modelPar_given_Rs0;
double modelPar_mt;
double d_modelPar_mt_dX;
bool modelPar_given_mt;
double modelPar_ml;
double d_modelPar_ml_dX;
bool modelPar_given_ml;
double modelPar_nu;
double d_modelPar_nu_dX;
bool modelPar_given_nu;
...
{
  static const char *name() {return "MVS ETSOI 2.0.0";}
  static const char *deviceTypeName() {return "M level 2000";}
...
public:
  ...
  public:
    // iterator reference to the mvs_2_0_0_etsoi model which owns this instance.
    // Getters and setters
    Model &getModel()
    {
      return model_;
...
#endif //Xyce_N_DEV_ADMSmvs_2_0_0_etsoi_h
