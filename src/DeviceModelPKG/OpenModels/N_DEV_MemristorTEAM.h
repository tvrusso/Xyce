...
// sensitivity functor
// not yet implemented.
class memristorTEAMSensitivity :  public baseSensitivity
{
  public:
...
{
  static const char *name() {return "MemristorTEAM";}
  static const char *deviceTypeName() {return "YMEMRISTOR level 2";}
...
//-----------------------------------------------------------------------------
// Class         : Xyce::Device::MemristorTEAM::Instance
// Purpose       :
// Special Notes :
// Creator       : Richard Schiek, Electrical Models & Simulations
// Creation Date : 10/23/2014
//-----------------------------------------------------------------------------
//
// MemristorTEAM device instance class.
//
...
class Instance : public DeviceInstance
{
  ...
  friend class Master;
  friend class memristorTEAMSensitivity;
...
public:
  ...
  //---------------------------------------------------------------------------
  // Function      : Xyce::Device::MemristorTEAM::Instance::getModel
  // Purpose       : destructor
  // Special Notes :
  // Scope         : public
  // Creator       : Richard Schiek, Electrical Models & Simulations
  ...
  //
  // @return reference to the owning MemristorTEAM::Model
  //
  ...
  //---------------------------------------------------------------------------
  // Function      : Xyce::Device::MemristorTEAM::Instance::jacobianStamp
  // Purpose       :
  // Special Notes :
  // Scope         : public
  // Creator       : Richard Schiek, Electrical Models & Simulations
...
private:
  static std::vector< std::vector<int> >  jacStamp; //< All MemristorTEAM instances have a common Jacobian Stamp
...
//-----------------------------------------------------------------------------
// Class         : Xyce::Device::MemristorTEAM::Model
// Purpose       :
// Special Notes :
// Creator       : Richard Schiek, Electrical Models & Simulations
// Creation Date : 10/23/2014
...
public:
  ...
  //---------------------------------------------------------------------------
  // Function      : Xyce::Device::MemristorTEAM::Model::addInstance
  // Purpose       :
  // Special Notes :
  // Scope         : public
  // Creator       : Richard Schiek, Electrical Models & Simulations
...
//-----------------------------------------------------------------------------
// Class         : Xyce::Device::MemristorTEAM::Master
// Purpose       :
// Special Notes :
// Creator       : Richard Schiek, Electrical Models & Simulations
// Creation Date : 10/23/2014 
...
//
// For efficiency, the MemristorTEAM class reimplements these methods to do the
...
public:
  ...
  //---------------------------------------------------------------------------
  // Function      : Xyce::Device::MemristorTEAM::Master::Master
  // Purpose       :
  // Special Notes :
  // Scope         : public
  // Creator       : Richard Schiek, Electrical Models & Simulations
  ...
  //---------------------------------------------------------------------------
  //
  // Construct a MemristorTEAM Device.
  //
  // @param configuration
  // @param factory_block
  // @param solver_state
...
#endif // Xyce_N_DEV_MemristorTEAM_h
