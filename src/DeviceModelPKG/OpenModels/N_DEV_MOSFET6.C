...
void Traits::loadInstanceParameters(ParametricData<MOSFET6::Instance> &p)
{
  ...
  p.addPar ("W",0.0,&MOSFET6::Instance::w)
   .setOriginalValueStored(true)
   .setUnit(U_METER)
   .setCategory(CAT_GEOMETRY)
  ...
  p.addPar ("OFF",false,&MOSFET6::Instance::OFF)
   .setUnit(U_LOGIC)
...
{
  p.addPar ("VTO",0.0,&MOSFET6::Model::vt0)
   .setUnit(U_VOLT)
   .setCategory(CAT_VOLT)
  ...
  p.addPar ("KV",2.0,&MOSFET6::Model::kv)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Saturation voltage factor");

  p.addPar ("NV",0.5,&MOSFET6::Model::nv)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Saturation voltage coeff.");

  p.addPar ("KC",5.0e-5,&MOSFET6::Model::kc)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Saturation current factor");

  p.addPar ("NC",1.0,&MOSFET6::Model::nc)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Saturation current coeff.");

  p.addPar ("NVTH",0.5,&MOSFET6::Model::nvth)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Threshold voltage coeff.");

  p.addPar ("PS",0.0,&MOSFET6::Model::ps)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Sat. current modification  par.");

  p.addPar ("GAMMA",0.0,&MOSFET6::Model::gamma)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Bulk threshold parameter");

  p.addPar ("GAMMA1",0.0,&MOSFET6::Model::gamma1)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Bulk threshold parameter 1");

  p.addPar ("SIGMA",0.0,&MOSFET6::Model::sigma)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Static feedback effect par.");

  p.addPar ("PHI",0.6,&MOSFET6::Model::phi)
   .setUnit(U_VOLT)
   .setCategory(CAT_PROCESS)
   .setDescription("Surface potential");

  p.addPar ("LAMBDA",0.0,&MOSFET6::Model::lambda)
   .setGivenMember(&MOSFET6::Model::lambdaGiven)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Channel length modulation param.");

  p.addPar ("LAMBDA0",0.0,&MOSFET6::Model::lambda0)
   .setGivenMember(&MOSFET6::Model::lambda0Given)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Channel length modulation param. 0");

  p.addPar ("LAMBDA1",0.0,&MOSFET6::Model::lambda1)
   .setGivenMember(&MOSFET6::Model::lambda1Given)
   .setUnit(U_NONE)
   .setCategory(CAT_NONE)
   .setDescription("Channel length modulation param. 1");

  p.addPar ("RD",0.0,&MOSFET6::Model::drainResistance)
   .setExpressionAccess(ParameterType::MIN_RES)
   .setUnit(U_OHM)
   .setCategory(CAT_RES)
   .setDescription("Drain ohmic resistance");

  p.addPar ("RS",0.0,&MOSFET6::Model::sourceResistance)
   .setExpressionAccess(ParameterType::MIN_RES)
   .setUnit(U_OHM)
   .setCategory(CAT_RES)
   .setDescription("Source ohmic resistance");

  p.addPar ("CBD",0.0,&MOSFET6::Model::capBD)
   .setExpressionAccess(ParameterType::MIN_CAP)
   .setGivenMember(&MOSFET6::Model::capBDGiven)
   .setUnit(U_FARAD)
   .setCategory(CAT_CAP)
   .setDescription("Zero-bias bulk-drain p-n capacitance");

  p.addPar ("CBS",0.0,&MOSFET6::Model::capBS)
   .setExpressionAccess(ParameterType::MIN_CAP)
   .setGivenMember(&MOSFET6::Model::capBSGiven)
   .setUnit(U_FARAD)
   .setCategory(CAT_CAP)
   .setDescription("Zero-bias bulk-source p-n capacitance");

  p.addPar ("IS",1e-14,&MOSFET6::Model::jctSatCur)
   .setUnit(U_AMP)
   .setCategory(CAT_CURRENT)
   .setDescription("Bulk p-n saturation current");

  p.addPar ("PB",0.8,&MOSFET6::Model::bulkJctPotential)
   .setUnit(U_VOLT)
   .setCategory(CAT_VOLT)
   .setDescription("Bulk p-n bottom potential");

  p.addPar ("CGSO",0.0,&MOSFET6::Model::gateSourceOverlapCapFactor)
   .setUnit(U_FARADMM1)
   .setCategory(CAT_CAP)
   .setDescription("Gate-source overlap capacitance/channel width");

  p.addPar ("CGDO",0.0,&MOSFET6::Model::gateDrainOverlapCapFactor)
   .setUnit(U_FARADMM1)
   .setCategory(CAT_CAP)
   .setDescription("Gate-drain overlap capacitance/channel width");

  p.addPar ("CGBO",0.0,&MOSFET6::Model::gateBulkOverlapCapFactor)
   .setUnit(U_FARADMM1)
   .setCategory(CAT_CAP)
   .setDescription("Gate-bulk overlap capacitance/channel length");

  p.addPar ("RSH",0.0,&MOSFET6::Model::sheetResistance)
   .setUnit(U_OHM)
   .setCategory(CAT_RES)
   .setDescription("Drain,source diffusion sheet resistance");

  p.addPar ("CJ",0.0,&MOSFET6::Model::bulkCapFactor)
   .setGivenMember(&MOSFET6::Model::bulkCapFactorGiven)
   .setUnit(U_FARADMM2)
   .setCategory(CAT_CAP)
   .setDescription("Bulk p-n zero-bias bottom capacitance/area");

  p.addPar ("MJ",0.5,&MOSFET6::Model::bulkJctBotGradingCoeff)
   .setUnit(U_NONE)
   .setCategory(CAT_DOPING)
   .setDescription("Bulk p-n bottom grading coefficient");

  p.addPar ("CJSW",0.0,&MOSFET6::Model::sideWallCapFactor)
   .setGivenMember(&MOSFET6::Model::sideWallCapFactorGiven)
   .setUnit(U_FARADMM2)
   .setCategory(CAT_CAP)
   .setDescription("Bulk p-n zero-bias sidewall capacitance/area");

  p.addPar ("MJSW",0.5,&MOSFET6::Model::bulkJctSideGradingCoeff)
   .setUnit(U_NONE)
   .setCategory(CAT_DOPING)
   .setDescription("Bulk p-n sidewall grading coefficient");

  p.addPar ("JS",0.0,&MOSFET6::Model::jctSatCurDensity)
   .setUnit(U_AMPMM2)
   .setCategory(CAT_PROCESS)
   .setDescription("Bulk p-n saturation current density");

  p.addPar ("TOX",1e-7,&MOSFET6::Model::oxideThickness)
   .setOriginalValueStored(true)
   .setUnit(U_METER)
   .setCategory(CAT_GEOMETRY)
   .setDescription("Gate oxide thickness");

  p.addPar ("LD",0.0,&MOSFET6::Model::latDiff)
   .setUnit(U_METER)
   .setCategory(CAT_DOPING)
   .setDescription("Lateral diffusion length");

  p.addPar ("UO",600.0,&MOSFET6::Model::surfaceMobility)
  ...
  p.addPar ("NSUB",0.0,&MOSFET6::Model::substrateDoping)
   .setUnit(U_CMM3)
   .setCategory(CAT_DOPING)
   .setDescription("Substrate doping density");

  p.addPar ("NSS",0.0,&MOSFET6::Model::surfaceStateDensity)
   .setUnit(U_CMM2)
   .setCategory(CAT_PROCESS)
   .setDescription("Surface state density");

  p.addPar ("TNOM",27.0,&MOSFET6::Model::tnom)
   .setUnit(STANDARD)
   .setCategory(CAT_NONE)
   .setDescription("Parameter measurement temperature");

  p.addPar ("KF",0.0,&MOSFET6::Model::fNcoef)
   .setUnit(U_NONE)
   .setCategory(CAT_FLICKER)
   .setDescription("Flicker noise coefficient");

  p.addPar ("AF",1.0,&MOSFET6::Model::fNexp)
   .setUnit(U_NONE)
   .setCategory(CAT_FLICKER)
   .setDescription("Flicker noise exponent");

  // Set up non-double precision variables:
  p.addPar ("TPG",1,&MOSFET6::Model::gateType)
   .setUnit(U_NONE)
...
bool Instance::updateIntermediateVars ()
{
...

  {
    ...
    else
    {
      ...
      {
        arg=0;
        vonbm=0;  // vonbm must be initialized before used!
      }
      else
      {
        if ((mode==1?vbs:vbd) <= 0 )
...
//-----------------------------------------------------------------------------
// Function      : Xyce::Device::MOSFET6::Instance::getNumNoiseSources
// Purpose       : 
// Special Notes :
// Scope         : public
// Creator       : Eric Keiter, SNL
...
//-----------------------------------------------------------------------------
// Function      : Xyce::Device::MOSFET6::Instance::setupNoiseSources
// Purpose       :
// Special Notes :
// Scope         : public
// Creator       : Eric Keiter
...
//-----------------------------------------------------------------------------
// Function      : Xyce::Device::MOSFET6::Instance::getNoiseSources
// Purpose       :
// Special Notes :
// Scope         : public
// Creator       : Eric Keiter
...
{
  if (deviceMap.empty() ||
      ((deviceMap.find("M")!=deviceMap.end()) && (levelSet.find(6)!=levelSet.end())))
  {
