...
//-------------------------------------------------------------------------
//
// Purpose        : This file implements a handful of functions
//                  for the BSIM4 MOSFET model.  It
//                  is intended to be compatible with the Berkeley SPICE
//                  (3f5) version, BSIM4 version 4.6.1 and implements only
//                  those functions that differ from version to version.
//
// Special Notes  : Ripped out of the original N_DEV_MOSFET_B4.C file
//                  when support for multiple versions was added.
//
//
//-------------------------------------------------------------------------
...
// Purpose       : version-specific process params for 4.6.1
