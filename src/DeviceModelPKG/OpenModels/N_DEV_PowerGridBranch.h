...
#ifndef Xyce_N_DEV_PowerGridBranch_h
#define Xyce_N_DEV_PowerGridBranch_h
...
{
  static const char *name() {return "PowerGridBranch";}
  static const char *deviceTypeName() {return "PowerGridBranch level 1";}
...
// Purpose       :
//
//	This  is  the  instance class  for a Power Grid Branch device.  
//
// Special Notes :
// Creator        : Pete Sholander, SNL, Electrical and Microsystems Modeling
...
private:
  ...
  double branchResistance_,branchReactance_,branchSusceptance_;

  // enum-based version of the analysisTypeStr_
  enum aType analysisType_;
  
  // turnsRatio_ was moved into the transformer model
  //double turnsRatio_;
  // Shunt parameters were moved into the bus shunt model
  //double bus1ShuntConductance_, bus2ShuntConductance_;
  //double bus1ShuntSusceptance_, bus2ShuntSusceptance_;

  // definitions for power grid branch device
...
#endif // Xyce_N_DEV_PowerGridBranch_h
