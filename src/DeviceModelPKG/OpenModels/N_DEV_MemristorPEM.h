...
#ifndef Xyce_N_DEV_MemristorPEM_h
#define Xyce_N_DEV_MemristorPEM_h
...
// sensitivity functor
// not yet implemented.
class memristorPEMSensitivity :  public baseSensitivity
{
  public:
  memristorPEMSensitivity() : 
    baseSensitivity() {};

  virtual ~memristorPEMSensitivity() {};
...
static memristorPEMSensitivity memrSens;

struct Traits : public DeviceTraits<Model, Instance, MemristorTEAM::Traits>
{
  static const char *name() {return "MemristorPEM";}
...
//-----------------------------------------------------------------------------
// Class         : Xyce::Device::MemristorPEM::Instance
// Purpose       :
// Special Notes :
// Creator       : Richard Schiek, Electrical Models & Simulations
// Creation Date : 10/23/2014
//-----------------------------------------------------------------------------
//
// MemristorPEM device instance class.
//
...
class Instance : public DeviceInstance
{
  ...
  friend class Master;
  friend class memristorPEMSensitivity;
...
public:
  ...
  //---------------------------------------------------------------------------
  // Function      : Xyce::Device::MemristorPEM::Instance::getModel
  // Purpose       : destructor
  // Special Notes :
  // Scope         : public
  // Creator       : Richard Schiek, Electrical Models & Simulations
  ...
  //
  // @return reference to the owning MemristorPEM::Model
  //
  ...
  //---------------------------------------------------------------------------
  // Function      : Xyce::Device::MemristorPEM::Instance::jacobianStamp
  // Purpose       :
  // Special Notes :
  // Scope         : public
  // Creator       : Richard Schiek, Electrical Models & Simulations
...
private:
  static std::vector< std::vector<int> >  jacStamp; //< All MemristorPEM instances have a common Jacobian Stamp
...
//-----------------------------------------------------------------------------
// Class         : Xyce::Device::MemristorPEM::Model
// Purpose       :
// Special Notes :
// Creator       : Richard Schiek, Electrical Models & Simulations
// Creation Date : 10/23/2014
...
public:
  ...
  //---------------------------------------------------------------------------
  // Function      : Xyce::Device::MemristorPEM::Model::addInstance
  // Purpose       :
  // Special Notes :
  // Scope         : public
  // Creator       : Richard Schiek, Electrical Models & Simulations
...
private:
  ...
  // model parameters for PEM model
  double      V1_;
  double      V2_;
  double      I1_;
  double      I2_;
  ...
  double      C1_; 
  double      C2_; 
  std::string fxPDataFileName_;
  std::string fxMDataFileName_;
  
  //
  // These arrays contain the PWL points for F 
  //
  
  Util::linear<double> FpInterp;
  Util::linear<double> FmInterp;
  
  double xMin;  // min X in xmData 
  double xMax;  // max X in xpData
  std::vector<double> xpData;
  std::vector<double> fpData;
  std::vector<double> xmData;
  std::vector<double> fmData;
...
//-----------------------------------------------------------------------------
// Class         : Xyce::Device::MemristorPEM::Master
// Purpose       :
// Special Notes :
// Creator       : Richard Schiek, Electrical Models & Simulations
// Creation Date : 10/23/2014 
...
//
// For efficiency, the MemristorPEM class reimplements these methods to do the
...
public:
  ...
  //---------------------------------------------------------------------------
  // Function      : Xyce::Device::MemristorPEM::Master::Master
  // Purpose       :
  // Special Notes :
  // Scope         : public
  // Creator       : Richard Schiek, Electrical Models & Simulations
  ...
  //---------------------------------------------------------------------------
  //
  // Construct a MemristorPEM Device.
  //
  // @param configuration
  // @param factory_block
  // @param solver_state
...
#endif // Xyce_N_DEV_MemristorPEM_h
