...
#ifndef Xyce_N_IO_OutputterPCETecplot_h
#define Xyce_N_IO_OutputterPCETecplot_h
...
class PCETecplot : public Interface
{
public:
  PCETecplot(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);

  virtual ~PCETecplot();

private:
  PCETecplot(const PCETecplot &);
  PCETecplot &operator=(const PCETecplot &);
...
#endif // Xyce_N_IO_OutputterPCETecplot_h
