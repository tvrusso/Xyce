...
#ifndef Xyce_N_IO_OutputterSensitivityACCSV_h
#define Xyce_N_IO_OutputterSensitivityACCSV_h
...
class SensitivityACCSV : public Interface
{
public:
  SensitivityACCSV(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);

  virtual ~SensitivityACCSV();

private:
  SensitivityACCSV(const SensitivityACCSV &);
  SensitivityACCSV &operator=(const SensitivityACCSV &);
...
#endif // Xyce_N_IO_OutputterSensitivityACCSV_h
