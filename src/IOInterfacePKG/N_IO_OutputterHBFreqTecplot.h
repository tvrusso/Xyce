...
#ifndef Xyce_N_IO_OutputterHBFreqTecplot_h
#define Xyce_N_IO_OutputterHBFreqTecplot_h
...
class HBFreqTecPlot : public HBInterface
{
public:
  HBFreqTecPlot(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &freq_print_parameters);

  virtual ~HBFreqTecPlot();

private:
  HBFreqTecPlot(const HBFreqTecPlot &);
  HBFreqTecPlot &operator=(const HBFreqTecPlot &);
...
#endif // Xyce_N_IO_OutputterHBFreqTecplot_h
