...
#ifndef Xyce_N_IO_OutputterNoiseTecplot_h
#define Xyce_N_IO_OutputterNoiseTecplot_h
...
class NoiseTecPlot : public Interface
{
public:
  NoiseTecPlot(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);

  virtual ~NoiseTecPlot();

private:
  NoiseTecPlot(const NoiseTecPlot &);
  NoiseTecPlot &operator=(const NoiseTecPlot &);
