...
//-----------------------------------------------------------------------------
//
// Purpose        : Declares the DistToolDevBalanced class.  Distribution tool
...
#ifndef Xyce_N_IO_DistToolDevBalanced_h
#define Xyce_N_IO_DistToolDevBalanced_h
...
//-----------------------------------------------------------------------------
class DistToolDevBalanced: public DistToolBase
{
public:
  DistToolDevBalanced(
...
private:
  ...
  std::vector<DeviceCountMap>   procDeviceCountTable_;  ///< device count map for each processor
  std::vector<int>              procDeviceCountVec_;    ///< device per processor map
  std::vector<bool>             procEndDeviceLines_;    ///< keep track of who has been told to stop processing lines
...
#endif // Xyce_N_IO_DistToolDevBalanced_h
