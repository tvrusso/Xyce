...
//-----------------------------------------------------------------------------
// Function      : SensitivityCSV::SensitivityCSV
// Purpose       : constructor
// Special Notes :
// Scope         :
    ...
    numberOfSteps_(0)
{
  ...
  {
    printParameters_.defaultExtension_ = "SENS.csv";
  }
...
//-----------------------------------------------------------------------------
// Function      : SensitivityCSV::sensitivityHeader
// Purpose       :
// Special Notes :
// Scope         :
// Creator       : Pete Sholander
// Creation Date : 9/26/2017
//-----------------------------------------------------------------------------
void SensitivityCSV::sensitivityHeader()
{
  int column_index = 0;
...
//-----------------------------------------------------------------------------
// Function      : SensitivityCSV::doOutputSensitivity
// Purpose       :
// Special Notes :
// Scope         :
// Creator       : Pete Sholander
// Creation Date : 9/26/2017
//-----------------------------------------------------------------------------
void SensitivityCSV::doOutputSensitivity(
  Parallel::Machine             comm,
...
//-----------------------------------------------------------------------------
// Function      : SensitivityCSV::doFinishOutput
...
// Creation Date : 9/26/2017
//-----------------------------------------------------------------------------
void SensitivityCSV::doFinishOutput()
{
  if (os_)
  {
    if (numberOfSteps_ == 0)
...
//-----------------------------------------------------------------------------
// Function      : SensitivityCSV::doStartStep
...
// Creation Date :
//-----------------------------------------------------------------------------
void SensitivityCSV::doStartStep( int current_step, int number_of_steps)
{
  index_ = 0;
...
//-----------------------------------------------------------------------------
// Function      : SensitivityCSV::doResetIndex
...
// Creation Date :
//-----------------------------------------------------------------------------
void SensitivityCSV::doResetIndex()
{
  index_ = 0;
}

//-----------------------------------------------------------------------------
// Function      : SensitivityCSV::doSteppingComplete
...
// Creation Date : 9/26/2017
//-----------------------------------------------------------------------------
void SensitivityCSV::doSteppingComplete()
{
