...
//
// Creation Date  : 7/24/2107
//
//-----------------------------------------------------------------------------

#ifndef Xyce_N_IO_OutputterHomotopyCSV_h
#define Xyce_N_IO_OutputterHomotopyCSV_h
...
class HomotopyCSV : public Interface
{
public:
  HomotopyCSV(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);

  virtual ~HomotopyCSV();

private:
  HomotopyCSV(const HomotopyCSV &);
  HomotopyCSV &operator=(const HomotopyCSV &);
...
#endif // Xyce_N_IO_OutputterHomotopyCSV_h
