...
#ifndef Xyce_N_IO_OutputterEmbeddedSamplingCSV_h
#define Xyce_N_IO_OutputterEmbeddedSamplingCSV_h
...
class EmbeddedSamplingCSV : public Interface
{
public:
  EmbeddedSamplingCSV(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);

  virtual ~EmbeddedSamplingCSV();

private:
  EmbeddedSamplingCSV(const EmbeddedSamplingCSV &);
  EmbeddedSamplingCSV &operator=(const EmbeddedSamplingCSV &);
...
#endif // Xyce_N_IO_OutputterEmbeddedSamplingCSV_h
