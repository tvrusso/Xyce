...
#ifndef Xyce_N_IO_OutputterEmbeddedSamplingTecplot_h
#define Xyce_N_IO_OutputterEmbeddedSamplingTecplot_h
...
class EmbeddedSamplingTecplot : public Interface
{
public:
  EmbeddedSamplingTecplot(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);

  virtual ~EmbeddedSamplingTecplot();

private:
  EmbeddedSamplingTecplot(const EmbeddedSamplingTecplot &);
  EmbeddedSamplingTecplot &operator=(const EmbeddedSamplingTecplot &);
...
private:
  ...
  void outputAuxData(std::ostream &os);
...
#endif // Xyce_N_IO_OutputterEmbeddedSamplingTecplot_h
