...
//-----------------------------------------------------------------------------
//
// Purpose        : The outputter class for .PRINT HB_TD for FORMAT=CSV
//
// Special Notes  :
//
...
#ifndef Xyce_N_IO_OutputterHBTimeCSV_h
#define Xyce_N_IO_OutputterHBTimeCSV_h
...
class HBTimeCSV : public HBInterface
{
public:
  HBTimeCSV(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &time_print_parameters);

  virtual ~HBTimeCSV();

private:
  HBTimeCSV(const HBTimeCSV &);
  HBTimeCSV &operator=(const HBTimeCSV &);
...
#endif // Xyce_N_IO_OutputterHBTimeCSV_h
