...
#ifndef Xyce_N_IO_OutputCsd_h
#define Xyce_N_IO_OutputCsd_h
...
class OutputCsd : public OutputFileBase
{
  public:
    ...
    void splitCsdFileLine( const std::string&, std::vector<std::string>& );
    bool handleEndOfCsdFileDataBlock( std::vector<std::string>& );
