...
#ifndef Xyce_N_IO_OutputterNoiseCSV_h
#define Xyce_N_IO_OutputterNoiseCSV_h
...
class NoiseCSV : public Interface
{
public:
  NoiseCSV(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);

  virtual ~NoiseCSV();

private:
  NoiseCSV(const NoiseCSV &);
  NoiseCSV &operator=(const NoiseCSV &);
...
#endif // Xyce_N_IO_OutputterNoiseCSV_h
