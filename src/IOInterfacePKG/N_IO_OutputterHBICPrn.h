...
#ifndef Xyce_N_IO_OutputterHBICPrn_h
#define Xyce_N_IO_OutputterHBICPrn_h
...
//-----------------------------------------------------------------------------
// Class         : HBICPrn
// Purpose       : Outputter class for HB_IC and "PRN" (Standard)
//                 output format
// Special Notes :
// Creator       : Pete Sholander, SNL
// Creation Date : 11/19/2019
//-----------------------------------------------------------------------------
class HBICPrn : public TimeInterface
{
public:
  HBICPrn(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);

  virtual ~HBICPrn();

private:
  HBICPrn(const HBICPrn &);
  HBICPrn &operator=(const HBICPrn &);
...
#endif // Xyce_N_IO_OutputterHBICPrn_h
