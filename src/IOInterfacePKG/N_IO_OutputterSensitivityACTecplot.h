...
#ifndef Xyce_N_IO_OutputterSensitivityACTecplot_h
#define Xyce_N_IO_OutputterSensitivityACTecplot_h
...
class SensitivityACTecplot : public Interface
{
public:
  SensitivityACTecplot(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);

  virtual ~SensitivityACTecplot();

private:
  SensitivityACTecplot(const SensitivityACTecplot &);
  SensitivityACTecplot &operator=(const SensitivityACTecplot &);
...
#endif // Xyce_N_IO_OutputterSensitivityACTecplot_h
