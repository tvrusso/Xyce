...
#ifndef Xyce_N_IO_OutputterPCECSV_h
#define Xyce_N_IO_OutputterPCECSV_h
...
class PCECSV : public Interface
{
public:
  PCECSV(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);

  virtual ~PCECSV();

private:
  PCECSV(const PCECSV &);
  PCECSV &operator=(const PCECSV &);
...
#endif // Xyce_N_IO_OutputterPCECSV_h
