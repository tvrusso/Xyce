...
#ifndef Xyce_N_IO_OutputterHBTimeTecplot_h
#define Xyce_N_IO_OutputterHBTimeTecplot_h
...
class HBTimeTecPlot : public HBInterface
{
public:
  HBTimeTecPlot(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &time_print_parameters);

  virtual ~HBTimeTecPlot();

private:
  HBTimeTecPlot(const HBTimeTecPlot &);
  HBTimeTecPlot &operator=(const HBTimeTecPlot &);
...
#endif // Xyce_N_IO_OutputterHBTimeTecplot_h
