...
// Special Notes  :
//
// Creator        : Peter Sholander, SNL, Electrical Models and Simulation
//
...
#ifndef Xyce_N_IO_OutputterHBFreqCSV_h
#define Xyce_N_IO_OutputterHBFreqCSV_h
...
class HBFreqCSV : public HBInterface
{
public:
  HBFreqCSV(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &freq_print_parameters);
  virtual ~HBFreqCSV();

private:
  HBFreqCSV(const HBFreqCSV &);
  HBFreqCSV &operator=(const HBFreqCSV &);
...
#endif // Xyce_N_IO_OutputterHBFreqCSV_h
