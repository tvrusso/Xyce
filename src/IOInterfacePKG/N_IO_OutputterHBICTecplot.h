...
#ifndef Xyce_N_IO_OutputterHBICTecplot_h
#define Xyce_N_IO_OutputterHBICTecplot_h
...
class HBICTecplot : public TimeInterface
{
public:
  HBICTecplot(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);

  virtual ~HBICTecplot();

private:
  HBICTecplot(const HBICTecplot &);
  HBICTecplot &operator=(const HBICTecplot &);
...
#endif // Xyce_N_IO_OutputterHBICTecplot_h
