...
#ifndef Xyce_N_LAS_TranSolverFactory_h
#define Xyce_N_LAS_TranSolverFactory_h
...
//-----------------------------------------------------------------------------
// Class         : TranSolverFactory
// Purpose       :
// Special Notes :
// Creator       : Rob Hoekstra, SNL, Parallel Compuational Sciences
// Creation Date : 08/12/03
//-----------------------------------------------------------------------------
class TranSolverFactory : public SolverFactory 
{
...
#endif // Xyce_N_LAS_TranSolverFactory_h
