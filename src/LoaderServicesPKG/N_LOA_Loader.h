...
public:
  ...
  virtual void getSensParamsForDevice(const std::string & sensDeviceName, std::vector<std::string> & sensParams,
     std::vector<double> & origVals, Parallel::Communicator & parallel_comm) {};
