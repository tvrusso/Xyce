...
public:
  ...
  newExpression (const newExpression & right) :
    ...
    isScheduleDependent_(right.isScheduleDependent_),
  ...
  bool getScheduleDependent() { return isScheduleDependent_; }
  void setScheduleDependent(bool val) { isScheduleDependent_ = val; }
