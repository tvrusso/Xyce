...
%%
%% Nonlinear Solver Under Transient Options Table
%%
\small
...
%\multicolumn{3}{|l|}{ Same as NONLIN but applied to transient
%nonlinear solutions (not including DCOP).} \\ \hline
...
\texttt{MAXSTEP}\index{\texttt{MAXSTEP}} & Maximum number of Newton steps & 20
\\ \hline
